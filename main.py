...
def entering_index_address(message: telebot.types.Message):  # функция ввода
    # индекса и адреса
    """
...
def welcome_cabinet(message: telebot.types.Message):  # функция перехода кнопки
    # в "личный кабинет"
    """
...
def get_transport_company(message: telebot.types.Message):  # функция фиксации
    # данных о транспортной компании из бота в таблицу
    """
