...
def definition_credentials():
    ...
    Returns:
    Функция возвращает: values-список имен пользователей, result- список с вложенным словарем, в котором сохранен список пользователей,
...
def recording_transport_company(user_name: str, transport_company: str):
    ...
    Функция, которая принимает на вход два аргумента user_name и transport_company, которые будут получены от пользователя
...
def recording_data(user_name: str, dict_customer_data: dict):
    ...
    Функция, которая принимает на вход два аргумента user_name и dict_customer_data, которые будут получены от пользователя
    телеграм-бота. user_name будет идентифицирован перебором через цикл for данных из колонки 'C' подключенной гугл-таблицы.
    user_name пользователя будет автоматически распознан телеграмм-ботом, user_name из колонки 'C' будет введено оператором таблицы.
    Одновременно с работой цикла for включиться счетчик, который зафиксирует номер колонки в которой будет находиться необходимый нам user_name.
    Возможно один и тот же user_name будет встречаться несколько раз, если обращение за товаром к оператору таблицу(заказ товара)
...
def recording_delivery_address(user_name: str, dict_index_address: dict):
    ...
    Функция, которая принимает на вход два аргумента user_name и dict_index_address, которые будут получены от пользователя
    телеграм-бота. user_name будет идентифицирован перебором через цикл for данных из колонки 'C' подключенной гугл-таблицы.
    user_name пользователя будет автоматически распознан телеграмм-ботом, user_name из колонки 'C' будет введено оператором таблицы.
    Одновременно с работой цикла for включиться счетчик, который зафиксирует номер колонки в которой будет находиться необходимый нам user_name.
    Возможно один и тот же user_name будет встречаться несколько раз, если обращение за товаром к оператору таблицу(заказ товара)
...
def data_collection_function(user_name: str):
    ...
    Функция, которая принимает на вход один аргумента user_name, которые будут получены от пользователя
    телеграм-бота. user_name будет идентифицирован перебором через цикл for данных из колонки 'C' подключенной гугл-таблицы.
    user_name пользователя будет автоматически распознан телеграмм-ботом, user_name из колонки 'C' будет введено оператором таблицы.
    Одновременно с работой цикла for включиться счетчик, который зафиксирует номер колонки в которой будет находиться необходимый нам user_name.
    Возможно один и тот же user_name будет встречаться несколько раз, если обращение за товаром к оператору таблицу(заказ товара)
    ...
    user_name: str - Имя пользователя телеграмм, получается в каждой функции файла main.py
    Returns:
    Функция вернет значение report1, в которой у нас будет отфильтрованный список с данными о доставке из таблицы
    """
    values, service, sheets, result, credentials = definition_credentials()
    report1 = ""
    count = 0
...
def data_delivery_fuction(user_name: str):
    ...
    user_name: str - Имя пользователя телеграмм, получается в каждой функции файла main.py
    Returns:
    Функция вернет значение report2, в которой у нас будет отфильтрованный список с данными о пользователе из таблицы
    """
    values, service, sheets, result, credentials = definition_credentials()
    report2 = ""
    count = 0
